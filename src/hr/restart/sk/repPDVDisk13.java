...
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.ObjectFactory;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SAdresa;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SIsporuka;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SObracunSastavio;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SObrazacPDV;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SPoslovniSubjektProsireno;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SRazdoblje;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.STijelo;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SZaglavlje;
import hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0.SZastupnik;
...
public class repPDVDisk13 extends repDisk {
  JAXBContext context;
  ...
  private void generate() throws Exception {
    ...
    sobrazacpdv.setVerzijaSheme("7.0");
  }
...
Pod600  VI. UKUPNO RAZLIKA: ZA UPLATU/ZA POVRAT
  ...
  private hr.porezna_uprava.e_porezna.sheme.metapodaci.v2_0.SPDVmetapodaci getMeta() throws Exception {
    return MetaGenerator.generateSPDVmeta(raUser.getInstance().getImeUsera(), System.currentTimeMillis()+"", 
        "Prijava poreza na dodanu vrijednost", "ObrazacPDV-v7-0");
  }


  private void initialize() throws Exception {
    context = JAXBContext.newInstance("hr.porezna_uprava.e_porezna.sheme.zahtjevi.obrazacpdv.v7_0");
  ...
  public static void main(String[] args) {
    ...
    repPDVDisk13 a = new repPDVDisk13();
